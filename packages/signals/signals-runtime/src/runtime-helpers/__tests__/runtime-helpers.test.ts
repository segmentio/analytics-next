import { SignalsRuntimeHelpers, createSignalsRuntimeHelpers } from '..'
import {
  createInstrumentationSignal,
  createInteractionSignal,
} from '../../factories/signal-factory'
import { InstrumentationSignal, InteractionSignal } from '../../types/web'

describe('SignalsRuntime', () => {
  let signalsRuntime: SignalsRuntimeHelpers
  ...
  beforeEach(() => {
    ...
    signalsRuntime = createSignalsRuntimeHelpers([signal1, signal2, signal3])
  })
