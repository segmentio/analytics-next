...
export class AnalyticsCore extends Emitter {
  ...
  async trackClick(...args: LinkArgs): Promise<AnalyticsCore> {
  ...
  async trackLink(...args: LinkArgs): Promise<AnalyticsCore> {
    const autotrack = await import(
      /* webpackChunkName: "auto-track" */ './core/auto-track'
    )
    return autotrack.link.call(this, ...args)
  ...
  async trackSubmit(...args: FormArgs): Promise<AnalyticsCore> {
    const autotrack = await import(
      /* webpackChunkName: "auto-track" */ './core/auto-track'
    )
  ...
  async trackForm(...args: FormArgs): Promise<AnalyticsCore> {
    const autotrack = await import(
      /* webpackChunkName: "auto-track" */ './core/auto-track'
    )
    return autotrack.form.call(this, ...args)
  ...
  debug(toggle: boolean): AnalyticsCore {
  ...
  async addSourceMiddleware(fn: MiddlewareFunction): Promise<AnalyticsCore> {
   ...
   */
  use(legacyPluginFactory: (analytics: AnalyticsCore) => void): AnalyticsCore {
